# 
# Project automation script for fpga1 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source fpga1.tcl), then you can
...
proc remove_source_files {} {
  ...
  xfile remove [search *.v -type file]

   puts "$myScript: Removing sources from project..."
